...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "Para efectos de la rifa, la fecha y hora oficial son las publicadas por el organizador para México y se mantienen aunque el participante se encuentre en Estados Unidos, Guatemala o en otra zona horaria. El participante debe consultar la hora equivalente en su ubicación; el evento de referencia comienza en el momento oficial publicado, sin que su zona horaria modifique ese momento.",
