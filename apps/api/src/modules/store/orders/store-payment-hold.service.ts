  ...
  async create(data: any) {
    ...
    const items = data.items.map((item: any) => {
      ...
      return {
        ...
        productRingNumber: product.type === ProductType.BIRD ? product.ringNumber : null,
        productAge: product.type === ProductType.BIRD ? product.age : null,
        productPurpose: product.type === ProductType.BIRD ? product.purpose : null,
        ...
        data: {
          ...
          items: {
            create: hold.items.map((item) => ({
              ...
              productRingNumber: item.productRingNumber,
              productAge: item.productAge,
              productPurpose: item.productPurpose,
              quantity: item.quantity,
