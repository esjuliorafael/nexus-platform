  ...
  return (
    <section
      className={
        bare
          ? `contents ${className}`
          : `relative bg-bg-card border border-border-main shadow-sm transition-all duration-500 hover:shadow-xl hover:shadow-stone-200/30 dark:hover:shadow-none overflow-hidden group/section flex flex-col ${animate ? "animate-in fade-in slide-in-from-bottom-4 duration-600" : ""} ${className}`
      }
      style={
        bare
          ? undefined
    ...
    >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div
                  className="animate-in zoom-in-75 duration-700 [animation-fill-mode:both]"
                ...
                <div
                  className="animate-in fade-in slide-in-from-left-4 duration-700 [animation-fill-mode:both] flex min-w-0 flex-col"
                  style={{ gap: "var(--space-xs)", animationDelay: delay }}
                >
            ...
            {action && actionPlacement === "header" && (
              <div
                className={`w-full sm:w-auto shrink-0 [&>button]:w-full sm:[&>button]:w-auto animate-in fade-in zoom-in-95 duration-700 [animation-fill-mode:both] ${actionClassName}`}
                style={{ animationDelay: delay }}
              >
                {action}
              </div>
      ...
      {/* Content Area */}
      <div className="relative z-10 flex-1 h-full">{children}</div>
    </section>
  );
};
