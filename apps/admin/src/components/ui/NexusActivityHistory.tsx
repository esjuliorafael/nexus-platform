...
const EVENT_PRESENTATION: Record<string, EventPresentation> = {
  ...
  RAFFLE_CREATED: { label: "Rifa creada", icon: PackagePlus, variant: "brand" },
  RAFFLE_UPDATED: { label: "Rifa actualizada", icon: UserRoundCog, variant: "info" },
  RAFFLE_DATE_CHANGED: { label: "Fecha de la rifa cambiada", icon: Clock3, variant: "warning" },
  RAFFLE_STATUS_CHANGED: { label: "Estado de la rifa cambiado", icon: PauseCircle, variant: "info" },
  RAFFLE_PUBLICATION_CHANGED: { label: "Publicación actualizada", icon: PackageCheck, variant: "info" },
  RAFFLE_FEATURED_CHANGED: { label: "Destacado actualizado", icon: Star, variant: "warning" },
